...
Status: **v0.4.4.** Dois nichos de exemplo (`tasks/advocacia-atendimento/`, `tasks/clinica-triagem/`) com teste de fumaça [medido]; ferramentas das fases 2–6 (dados, baseline, treino, teste, ONNX, API em CPU, Docker) rodando com **dados sintéticos**, então os resultados são [simulação] do pipeline.
